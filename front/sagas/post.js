...
function* loadHashtagPosts(action) {
    try{
        ...
        console.error(e);
        yield put({ type: LOAD_HASHTAG_POSTS_FAILURE, error: e });
    }
}
...
function* loadUserPosts(action){
    try{   
            ...
            console.error(e);
            yield put( { type: LOAD_USER_POSTS_FAILURE , error: e });
    }
}
...
function* loadComments(action){
    try{   
            ...
            yield put({ type: LOAD_COMMENTS_SUCCESS , 
                        data: {postId: action.data, comments: result.data} });
    }catch(e){
            console.error(e);
...
function* uploadImages(action) {
    try{
       ...
       yield put({ type: UPLOAD_IMAGES_SUCCESS,
        ...
        console.error(e);
        yield put({ type: UPLOAD_IMAGES_FAILURE,  error: e });
    }
}
...
function* likePost(action) {
    try{
       ...
       yield put({ type: LIKE_POST_SUCCESS,
        ...
        console.error(e);
        yield put({ type: LIKE_POST_FAILURE,  error: e });
    }
}
...
function* unlikePost(action) {
    try{
       ...
       yield put({ type: UNLIKE_POST_SUCCESS,
        ...
        console.error(e);
        yield put({ type: UNLIKE_POST_FAILURE,  error: e });
    }
}
...
function* retweet(action) {
    try{
       ...
       yield put({ type: RETWEET_SUCCESS,
                    data: result.data,
                });

    }catch(e){
        console.error(e);
        yield put({ type: RETWEET_FAILURE,  error: e });
...
function* removePost(action) {
    try{
       ...
       yield put({ type: REMOVE_POST_OF_ME,
                    data: result.data,
        ...
        console.error(e);
        yield put({ type: REMOVE_POST_FAILURE,  error: e });
      }
}
...
function* loadPost(action) {
    try{
       ...
       yield put({ type: LOAD_POST_SUCCESS,
                    data: result.data,
                });
       }catch(e){
        console.error(e);
        yield put({ type: LOAD_POST_FAILURE,  error: e });
      }
}
